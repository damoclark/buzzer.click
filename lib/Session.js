...
Session.prototype.updateMaxTeams = function(maxTeams) {
    ...
    if (this.settings.maxTeams === constants.UNLIMITED) {
        return [false, constants.messages.UNLIMITED_TEAMS_CANNOT_BE_CHANGED_AFTER_START];
    }

    if (maxTeams === constants.UNLIMITED) {
        return [false, constants.messages.UNLIMITED_TEAMS_MUST_BE_SET_AT_SESSION_START];
    }
