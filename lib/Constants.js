...
function Constants() {
    ...
    this.socketMessageNames = {
         ...
         * @constant
         */
        HOST_SETTINGS_UPDATE_MESSAGE: 'HostSettingsUpdateMessage',
        /**
    ...
    this.messages = {
        ...
        /**
         * Message: Unlimited teams cannot be changed after session start.
         * @public
         * @constant
         */
        UNLIMITED_TEAMS_CANNOT_BE_CHANGED_AFTER_START: 'Unlimited teams cannot be changed after session start.',
        /**
         * Message: Unlimited teams must be set at session start.
         * @public
         * @constant
         */
        UNLIMITED_TEAMS_MUST_BE_SET_AT_SESSION_START: 'Unlimited teams must be set at session start.',
    };
}
