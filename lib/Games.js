...
Games.prototype.add = function(game)
{
	...
	if ('code' in game && game.gameCode != undefined)
		throw "Trying to add game again with code " + game.gameCode ;
...
Games.prototype.remove = function(o)
{
	...
	{
		throw "object hostCode does not exist: "+o.hostCode ;
	}
	...
	{
		throw "object gameCode does not exist: "+o.gameCode ;
	}
