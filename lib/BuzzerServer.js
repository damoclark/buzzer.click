  ...
  io.on('connection', function(socket){
		...
		socket.onMessage(MessageFactory.CREATEGAMEMESSAGE,function(message)
		{
			...
			try
			{
				...
				var e = new BuzzerError(BuzzerError.INVALID_CODE,"Bla bla bla!") ;
				throw e ;
			...
			catch(err)
			{
				if (err instanceof BuzzerError) {
					console.log('Inside catch for BuzzerError') ;
					var r = MessageFactory.create(MessageFactory.CREATEGAMECONFIRMMESSAGE) ;
