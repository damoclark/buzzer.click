...
/**
 * Expose the MessageFactory module to BuzzerServer so it too can create
 * message objects
 */
IOSocket.prototype.MessageFactory = MessageFactory ;
 ...
 */
IOSocket.prototype.emitMessage = function(message,fn)
{
